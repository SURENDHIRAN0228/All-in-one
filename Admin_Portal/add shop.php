...
<body>
	<?php include 'develop-head.php' ?>
	<form>
	<table align="center">
	<tr>
		<td>Shop name:</td>
		<td>
			<input type="text" palceholder="Enter Shop name" />
		</td>
	</tr>
	...
	<tr>
		<td>Shop Owner:</td>
		<td>
			<input type="text" palceholder="Enter owner name" />
		</td>
	</tr>
	<tr>
		<td>Address:</td>
		<td>
			<input type="textarea" palceholder="Enter owner name" />
		</td>
	</tr>
	<tr>
		<td>City:</td>
...
<option></option>
	...
	<tr><td>Shop Category:</td><td><select>
		<option>Dress</option>
		<option>Food</option>
...
<tr><td colspan="2" align="center"><button><a href="add shop final.php">Next</a></button></td></tr>

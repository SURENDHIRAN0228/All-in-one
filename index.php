	...
	<div style="width: 100%; height: 1560px">
				...
				<div id="nav-bar-left">
					...
					<li class="nav-left">
						...
						<select>
							...
							<option><a href="erode.php"><li>Erode</li></a></option>
							<a href="erode.php"><li>Erode</li></a>
							<option>Eral</option>
		...
		<div>
			<div class="left-side-box">
				<div id="grid-1">
					<a href="view-page.php">
						<div class="first" id="one">
							<img src="images/car-1.jpeg">
						</div>
						<div class="first" id="two">
							<h5 class="head5">
								Maruthi Showroom(chennai)
							</h5>
							<h2 class="head2">
								Volvo S60 New Model 2021&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
							</h2>
							<h1>
								&#8377 750000 &nbsp
								<h2 class="head3">
				...
				<div id="grid-2">
					...
					<div class="first" id="two">
						<h5 class="head5">
							Tata Showroom(Madurai)
						</h5>
						<h2 class="head2">
							Tata Harrier car available in 5 colours &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
						</h2>
						<h1>
							&#8377 250000 &nbsp
							<h2 class="head3">
			...
			<div class="right-side-box" id="grid-3">
				<div class="head4">
					<img src="images/mobile-1.jpg" id="img-9">
				</div>
				<div style="margin-left: 25px">
					<h5 class="head5">
						Kumar mobile shop(Thiruppur)
					</h5>
					<h2 class="head2">
						LG Electro pro(couple)
					</h2>
					<h1>
						&#8377 19500 &nbsp
						<h2 class="head3">
		...
		<div>
			<div class="left-side-box-1" id="grid-4">
				<div class="head4">
					<img src="images/mobile-2.png" id="img-9">
				</div>
				<div style="margin-left: 25px">
					<h5 class="head5">
						Chennai mobiles(Bhavani)
					</h5>
					<h2 class="head2">
						Nokia XT Max Ultra 
					</h2>
			...
			<div class="right-side-box-1">
				<div id="grid-5">
					...
					<div class="first" id="two">
						...
						<h2 class="head2">
							KTM Duke 390cc new model with bluetooth&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
						</h2>
						<h1>
							&#8377 150000 &nbsp
							<h2 class="head3">
				...
				<div id="grid-6">
					<div class="first" id="one">
						<img src="images/bike-2.jpg">
					</div>
					<div class="first" id="two">
						<h5 class="head5">
							Royal Enfield Showroom(Sulur)
						</h5>
						<h2 class="head2">
							Royal Enfield 350cc model 2021
						</h2>
						<h1>
							&#8377 250000 &nbsp
							<h2 class="head3">
	...
	<div style="height: 1410px">
		<div>
			<div class="left-side-box">
				<div id="grid-10">
					<a href="view-page.php">
						<div class="first" id="one">
							<img src="images/fur-1.jpg">
						</div>
						<div class="first" id="two">
							<h5 class="head5">
								Anand furnitures(THirunelveli)
							</h5>
							<h2 class="head2">
								Floral Print Daily Wear Georgatte Sofa&nbsp&nbsp&nbsp
							</h2>
							<h1>
								&#8377 75000 &nbsp
								<h2 class="head3">
				...
				<div id="grid-11">
					<div class="first" id="one">
						<img src="images/fur-2.jpg">
					</div>
					<div class="first" id="two">
						<h5 class="head5">
							Raj Furnitures(Naagai)
						</h5>
						<h2 class="head2">
							Self Design Hooded Neck Red Dinning table
						</h2>
						<h1>
							&#8377 25000 &nbsp
							<h2 class="head3">
			...
			<div class="right-side-box" id="grid-12">
				<div class="head4">
					<img src="images/fur-3.jpg" id="img-9">
				</div>
				<div style="margin-left: 25px">
					<h5 class="head5">
						Kumar new Fasions(Annur)
					</h5>
					<h2 class="head2">
						Special Wedding Sofa(couple)
					</h2>
					<h1>
						&#8377 19500 &nbsp
						<h2 class="head3">
		...
		<div>
			<div class="left-side-box-1" id="grid-13">
				<div class="head4">
					<img src="images/fur-5.jpg" id="img-9">
				</div>
				<div style="margin-left: 25px">
					<h5 class="head5">
						Kannan super homeworks(Theni)
					</h5>
					<h2 class="head2">
						Special evening Slap sofa set
					</h2>
					<h1>
						&#8377 12000 &nbsp
						<h2 class="head3">
			...
			<div class="right-side-box-1">
				<div id="grid-14">
					<a href="view-page.php">
						...
						<div class="first" id="two">
							...
							<h2 class="head2">
								Floral Print Daily Wear Georgatte Bat&nbsp&nbsp&nbsp
							</h2>
							<h1>
								&#8377 1500 &nbsp
								<h2 class="head3">
				...
				<div id="grid-15">
					...
					<div class="first" id="two">
						<h5 class="head5">
							Boyzz Sports(Chennai)
						</h5>
						<h2 class="head2">
							Self Design Men Hooded Neck Red Bat
						</h2>
						<h1>
							&#8377 250 &nbsp
							<h2 class="head3">
		...
		<div>
			<div class="left-side-box">
				<div id="grid-16">
					<a href="view-page.php">
						...
						<div class="first" id="two">
							<h5 class="head5">
								Anand Chudi's(Thivarur)
							</h5>
							<h2 class="head2">
								Floral Print Daily Wear Georgatte Chudi&nbsp&nbsp&nbsp
							</h2>
							<h1>
								&#8377 750 &nbsp
								<h2 class="head3">
				...
				<div id="grid-17">
					...
					<div class="first" id="two">
						...
						<h2 class="head2">
							Self Design Men Hooded Neck Red Coat Suit
						</h2>
						<h1>
							&#8377 2500 &nbsp
							<h2 class="head3">
			...
			<div class="right-side-box" id="grid-18">
				<div class="head4">
					<img src="images/img-9.jpg" id="img-9">
				</div>
				<div style="margin-left: 25px">
					<h5 class="head5">
						Men's Latest(karur)
